...
import com.cpilosenlaces.microservice.exception.UnauthorizeException;
...
public class JwtTokenProvider {
    ...
    public static final int JWT_TOKEN_VALIDITY = 86400000; // 24 hours in miliseconds of assigned time validated
